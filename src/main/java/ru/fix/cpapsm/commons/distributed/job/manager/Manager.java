...
import ru.fix.cpapsm.commons.distributed.job.manager.model.distribution.JobItem;
import ru.fix.cpapsm.commons.distributed.job.manager.model.distribution.JobState;
import ru.fix.cpapsm.commons.distributed.job.manager.model.distribution.WorkPoolItem;
import ru.fix.cpapsm.commons.distributed.job.manager.model.distribution.WorkerItem;
import ru.fix.cpapsm.commons.distributed.job.manager.strategy.factory.AssignmentStrategyFactory;
...
class Manager implements AutoCloseable {
    ...
    private void assignWorkPools(TransactionalClient transactionalClient, JobsSnapshot jobsSnapshot) throws Exception {
        ...
        for (Map.Entry<JobItem, JobState> jobAvailability : availabilityState.entrySet()) {
            ...
            ru.fix.cpapsm.commons.distributed.job.manager.strategy.AssignmentStrategy wpAssignmentStrategy =
